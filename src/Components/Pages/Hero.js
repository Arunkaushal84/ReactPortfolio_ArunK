  ...
  return (
    <div id="home" className="hero-container overflow-hidden ">
      <div className="relative min-w-screen h-screen hero-bg">
        ...
        <div className="absolute bg-slate-500 opacity-92 p-4 sm:p-8 top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 h-3/4 flex flex-col-reverse sm:flex-row justify-center items-center">
